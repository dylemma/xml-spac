...
and the [examples project](https://github.com/dylemma/xml-spac/tree/master/examples/src/main/scala/io/dylemma/xml/example) has a collection of annotated examples,
